    ...
    return (
        <footer>
            <div className="flex flex-col lg:flex-row text-white lg:h-[200px]">
                ...
                <div className="bg-[#111827] lg:w-1/2 flex flex-col justify-center lg:items-start  ">
                    <div className="flex flex-col space-y-3 lg:space-y-6  lg:ml-36 my-3 lg:my-0">
                        <p className="text-2xl text-center">FOLLOW US</p>
